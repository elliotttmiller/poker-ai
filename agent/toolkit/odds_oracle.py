...
class OddsOracle:
    ...
    def get_draw_completion_odds(self, draw_type: str, streets_remaining: str = 'turn_and_river') -> float:
        """
    ...
    def get_quick_recommendation(self, our_hand: str, position: str, board_texture: str = None) -> Dict[str, Any]:
        """
        ...
        return {
            ...
            'factors': {
                ...
                'board_danger': self.get_board_danger_level(board_texture) if board_texture else None
            }
        }
