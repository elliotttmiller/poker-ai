...
class EquityCalculator:
    ...
    def _deal_from_range(
        self, opponent_range: Dict[str, Any], deck: List[str], start_index: int
    ) -> Optional[List[str]]:
        """
    ...
    def _check_straight(self, sorted_ranks: List[int]) -> bool:
        ...
        if (
            12 in sorted_ranks
            and 3 in sorted_ranks
            and 2 in sorted_ranks
            and 1 in sorted_ranks
            and 0 in sorted_ranks
        ):
            return True
    ...
    def _classify_hand(
        self, sorted_ranks: List[Tuple[int, int]], is_flush: bool, is_straight: bool
    ) -> str:
    ...
    def _calculate_numeric_strength(
        self, hand_type: str, sorted_ranks: List[Tuple[int, int]], is_flush: bool, is_straight: bool
    ) -> int:
    ...
    def _analyze_simulation_results(
        self, results: List[Dict[str, Any]], num_opponents: int
    ) -> Dict[str, Any]:
    ...
    def calculate_pot_equity_needed(
        self, pot_size: int, bet_size: int, num_opponents: int = 1
    ) -> float:
        """
