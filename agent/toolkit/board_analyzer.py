...
class BoardAnalyzer:
    ...
    def _analyze_straight_draw_potential(
        self, ranks: List[int], board: List[str]
    ) -> Dict[str, Any]:
    ...
    def _is_open_ended_draw(self, board_ranks: List[int], straight_ranks: List[int]) -> bool:
        ...
        consecutive = all(board_in_straight[i + 1] - board_in_straight[i] == 1 for i in range(2))
    ...
    def _analyze_range_favorability(
        self, ranks: List[int], suits: List[str], texture_analysis: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
    ...
    def who_has_range_advantage(
        self, board: List[str], preflop_aggressor_position: str, caller_position: str
    ) -> Dict[str, Any]:
        """
    ...
    def _get_range_advantage_recommendation(
        self, advantage_holder: str, advantage_strength: float, texture_analysis: Dict[str, Any]
    ) -> str:
