        ...
        if not has_raise:
            ...
            if category == "premium" and strength >= 0.9:
                ...
                if num_raises == 1:
                    ...
                    if strength >= 0.95:
                        self.total_calls += 1
                        amount = self._get_nit_bet_sizing(
                            "call", pot_size, our_stack, valid_actions
                        )
                        return "call", amount
                    else:
            ...
            if facing_bet:
                ...
                if hand_strength > 0.8:
                    ...
                    if hand_strength > 0.9 and random.random() < 0.3:
                        ...
                        self.total_bets += 1
                        amount = self._get_nit_bet_sizing(
                            "raise", pot_size, our_stack, valid_actions
                        )
                        return "raise", amount
                    else:
                        # Usually just call
