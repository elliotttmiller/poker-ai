...
class TestEquityCalculator(unittest.TestCase):
    ...
    def test_multi_way_equity_calculation(self):
        ...
        opponent_ranges = [{"type": "tight"}, {"type": "loose"}]  # 2 opponents
...
class TestBoardAnalyzer(unittest.TestCase):
    ...
    def test_board_texture_analysis(self):
        ...
        self.assertGreater(wet_analysis["wetness_score"], dry_analysis["wetness_score"])

    def test_range_advantage_analysis(self):
        """Test range advantage calculation."""
        board = ["Ah", "Kc", "Qd"]

        advantage = self.analyzer.who_has_range_advantage(board, "BTN", "BB")
    ...
    def test_leak_analysis(self):
        ...
        session_logs = [
            ...
            },
            {
                ...
                "street": "flop",
                "seats": [{"seat_id": 1, "name": "us"}, {"seat_id": 2, "name": "opponent1"}],
                "our_seat_id": 1,
                "pot_size": 150,
